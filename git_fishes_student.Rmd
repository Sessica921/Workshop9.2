...
new_data_new <- -which(colnames(df) %in% c("loc","animal_id","sl","size"))
...
ggplot(target_data, mapping = aes(x = species, y = mean, colour=treatment))+
   geom_boxplot(aes(fill= treatment))+
   annotation_raster(acantho,0.5,1.5, 20,25)+
   annotation_raster(ambon,1.5,2.5, 30,35)+
   annotation_raster(chromis,2.5,3.5, 30,35)+
   annotation_raster(humbug,3.5,4.5, 25,30)+
   annotation_raster(lemon,4.5,5.5, 30,35)+
   annotation_raster(whitedams,5.5,6.5, 30,35)
