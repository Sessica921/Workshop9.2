...
Mean activity for `r "acantho"` in the control group was `r "re1$estimate"` (s / min) compared to the OA treatment group, which was `r "re1$estimate"` (s / min). The difference between control and OA treatment means was `r "max(re1$conf.int)-min(re1$conf.int)"` (s / min) (95% CI: `r "min(re1$conf.int)"` to `r "max(re1$conf.int)"`). 
